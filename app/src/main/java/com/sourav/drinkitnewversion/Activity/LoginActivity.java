...
import com.sourav.drinkitnewversion.Common.Common;
import com.sourav.drinkitnewversion.Helper.NetWorkConfig;
import com.sourav.drinkitnewversion.Model.Result;
import com.sourav.drinkitnewversion.Model.User;
        ...
        call.enqueue(new Callback<Result>() {
            ...
            public void onResponse(Call<Result> call, Response<Result> response) {
                ...
                if (!response.body().getError()) {
                    ...
                    Toasty.success(getApplicationContext(), "Welcome back " + response.body().getUser().getUsername(), Toast.LENGTH_SHORT, true).show();
